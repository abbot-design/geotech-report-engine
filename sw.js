...
const CACHE = "abbot-engine-v30";
const SHELL = ["./","./index.html","./manifest.webmanifest","./engine-manual.pdf","./icon-192.png","./icon-512.png","./assets/abbot-logo.svg","./vendor/qrcode.min.js","./info-sheets/manifest.js","./vendor/fonts/carlito-regular.woff2","./vendor/fonts/carlito-bold.woff2","./vendor/fonts/carlito-italic.woff2","./vendor/fonts/carlito-bolditalic.woff2","./info-sheets/pages/csiro-foundation-maintenance-01.jpg","./info-sheets/pages/csiro-foundation-maintenance-02.jpg","./info-sheets/pages/csiro-foundation-maintenance-03.jpg","./info-sheets/pages/csiro-foundation-maintenance-04.jpg"];
