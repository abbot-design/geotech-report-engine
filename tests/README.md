...
| `e2e/field-editor.spec.js` | The field tabs as used on site: two tabs, one open card, class-driven pickers, water depth disclosure, a ladder that grows without limit, tappable info panels, a legacy hole editable and unchanged in print. | The fieldwork redesign of September 2026, input side. |
